...
public class TesterMainController extends AbstractController {
    ...
    protected TesterMainController(Service service) {
        super(service);
    }

    @FXML
    protected void initialize() {
        nameText.setText(service.getCurrentTester().getFullName());
        usernameText.setText(service.getCurrentTester().getUsername());
    ...
    @FXML
    protected void onAddBugButtonPressed() throws IOException {
        ScreenController.switchScene((Stage) usernameText.getScene().getWindow(), "add_bug.fxml", new AddBugController(service));
    }
